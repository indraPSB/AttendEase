...
builder.Services.AddDbContext<AttendEaseDbContext>(optionsBuilder =>
{
    optionsBuilder.UseNpgsql(builder.Configuration.GetConnectionString("AttendEaseDatabase"))
        .UseAsyncSeeding(async (context, _, ct) =>
        {
            ...
            contacts[5].MessageSystem = $"Password was reset for user '{users[5].Name}' on '{contacts[5].Timestamp:G}'.";
            ...
            contacts[15].MessageSystem = $"Password was reset for user '{users[7].Name}' on '{contacts[15].Timestamp:G}'.";
            ...
            contacts[25].MessageSystem = $"Password was reset for user '{users[9].Name}' on '{contacts[25].Timestamp:G}'.";
            ...
            contacts[35].MessageSystem = $"Password was reset for user '{users[11].Name}' on '{contacts[35].Timestamp:G}'.";
            ...
            contacts[45].MessageSystem = $"Password was reset for user '{users[13].Name}' on '{contacts[45].Timestamp:G}'.";
